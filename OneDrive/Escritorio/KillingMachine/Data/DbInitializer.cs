...
public static class DbInitializer
{
    public static void Seed(AppDbContext db)
    {
        ...
        var trainers = new[]
        {
            new Trainer { FullName = "Carlos Mendoza", Specialty = "Fuerza e hipertrofia", Email = "carlos@killingmachine.local", Phone = "999111222", Biography = "Entrenador certificado con experiencia en progresion de fuerza.", Schedule = "Lunes a viernes 06:00-14:00" },
            new Trainer { FullName = "Andrea Torres", Specialty = "Entrenamiento funcional", Email = "andrea@killingmachine.local", Phone = "999333444", Biography = "Especialista en movilidad, acondicionamiento y entrenamiento grupal.", Schedule = "Lunes a sabado 14:00-22:00" }
        };
        ...
        {
            FullName = "Cliente Demostracion",
            DocumentNumber = "00000001",
            Email = "cliente@killingmachine.local",
            Phone = "999555666",
            BirthDate = new DateTime(1995, 5, 15),
            HeightCm = 175,
            JoinDate = DateTime.Today.AddMonths(-2),
            Notes = "Registro de ejemplo para visualizar el dashboard."
        };
        ...
        for (var i = 0; i < 8; i++)
        {
            db.WorkoutLogs.Add(new WorkoutLog
            {
                ...
                Notes = "Entrenamiento de demostracion"
            });
        }
        ...
        db.GalleryItems.AddRange(
            new GalleryItem { Title = "Identidad Killing Machine", ImageUrl = "/images/killing-machine-logo.png", Description = "Disciplina, constancia y progreso.", DisplayOrder = 1 },
